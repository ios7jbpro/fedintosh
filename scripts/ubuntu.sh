...
echo "Disabling Ubuntu extensions..."
...
# sudo apt install -y build-essential autoconf automake libtool pkg-config git meson ninja-build python3-pip gtk-doc-tools gnome-common sassc gjs libglib2.0-dev makepkg
# cd ~/.fedintosh
# mkdir "customshell"
# cd customshell
# echo "Fetching dependency gcr-4..."
# wget http://ftp.es.debian.org/debian/pool/main/g/gcr4/libgcr-4-dev_4.4.0.1-8_amd64.deb
# git clone https://gitlab.gnome.org/GNOME/gnome-shell
# cd gnome-shell
# echo "Installing deps..."
# sudo apt install libatk-bridge2.0-dev libecal2.0-dev libedataserver1.2-dev libical-dev
# meson setup _build
...
echo "WARNING: Skipping this step as Ubuntu is too outdated to support this."
echo "App blur will be turned off."
